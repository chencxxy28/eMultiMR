...
For the MultiR estimate, we consider two wrong PS models and two wrong CM models. First, run the function `est.fct.or()` to obtain the estimating function from the CM method.
```{r,message=FALSE,eval=FALSE}
...
Run the function `multir.est()` to obtain the MultiR estimate
```{r,message=FALSE,eval=FALSE}  
...
Run the function `multir.ib.est()` to obtain the eMultiR estimate with information borrow
```{r,message=FALSE,eval=FALSE}
